...
export const CustomerDetail = (props: ICustomerDetailProps) => {
  ...
  return (
    <Row>
      <Col md="8">
        <h2>
          <Translate contentKey="threedshopApp.customer.detail.title">Customer</Translate> [<b>{customerEntity.id}</b>]
        </h2>
        <dl className="jh-entity-details">
          ...
          <dd>{customerEntity.district}</dd>
          <dt>
            <Translate contentKey="threedshopApp.customer.order">Order</Translate>
          </dt>
          <dd>{customerEntity.order ? customerEntity.order.id : ''}</dd>
        </dl>
