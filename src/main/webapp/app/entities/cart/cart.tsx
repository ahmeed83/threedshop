...
export const Cart = (props: ICartProps) => {
  ...
  const { cartList, match } = props;
  return (
    <div>
      <h2 id="cart-heading">
        <Translate contentKey="threedshopApp.cart.home.title">Carts</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="threedshopApp.cart.home.createLabel">Create new Cart</Translate>
        </Link>
      </h2>
      <div className="table-responsive">
        {cartList && cartList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="threedshopApp.cart.cartTotal">Cart Total</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          <div className="alert alert-warning">
            <Translate contentKey="threedshopApp.cart.home.notFound">No Carts found</Translate>
          </div>
        )}
      </div>
    </div>
