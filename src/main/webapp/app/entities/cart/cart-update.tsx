  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="threedshopApp.cart.home.createOrEditLabel">
            <Translate contentKey="threedshopApp.cart.home.createOrEditLabel">Create or edit a Cart</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : cartEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="cartTotalLabel" for="cart-cartTotal">
