...
export const CategoryDetail = (props: ICategoryDetailProps) => {
  ...
  return (
    <Row>
      <Col md="8">
        <h2>
          <Translate contentKey="threedshopApp.category.detail.title">Category</Translate> [<b>{categoryEntity.id}</b>]
        </h2>
        <dl className="jh-entity-details">
          ...
          <dd>
            <TextFormat value={categoryEntity.lastUpdate} type="date" format={APP_LOCAL_DATE_FORMAT} />
          </dd>
        </dl>
