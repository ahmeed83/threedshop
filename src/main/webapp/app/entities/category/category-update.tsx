  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="threedshopApp.category.home.createOrEditLabel">
            <Translate contentKey="threedshopApp.category.home.createOrEditLabel">Create or edit a Category</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : categoryEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="lastUpdateLabel" for="category-lastUpdate">
