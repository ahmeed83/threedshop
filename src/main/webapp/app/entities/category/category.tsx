  ...
  return (
    <div>
      <h2 id="category-heading">
        <Translate contentKey="threedshopApp.category.home.title">Categories</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="threedshopApp.category.home.createLabel">Create new Category</Translate>
        </Link>
      </h2>
      <div className="table-responsive">
        {categoryList && categoryList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="threedshopApp.category.name">Name</Translate>
                </th>
                <th>
                  <Translate contentKey="threedshopApp.category.lastUpdate">Last Update</Translate>
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {categoryList.map((category, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{category.name}</td>
                  <td>
                    <TextFormat type="date" value={category.lastUpdate} format={APP_LOCAL_DATE_FORMAT} />
                  </td>
          ...
          <div className="alert alert-warning">
            <Translate contentKey="threedshopApp.category.home.notFound">No Categories found</Translate>
          </div>
        )}
      </div>
    </div>
