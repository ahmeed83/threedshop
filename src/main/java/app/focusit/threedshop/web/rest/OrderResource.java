...
import app.focusit.threedshop.domain.Order;
import app.focusit.threedshop.repository.OrderRepository;
...
/**
 * REST controller for managing {@link app.focusit.threedshop.domain.Order}.
 */
@RestController
@RequestMapping("/api")
@Transactional
