...
import app.focusit.threedshop.domain.Cart;
import app.focusit.threedshop.repository.CartRepository;
...
/**
 * REST controller for managing {@link app.focusit.threedshop.domain.Cart}.
 */
@RestController
@RequestMapping("/api")
@Transactional
