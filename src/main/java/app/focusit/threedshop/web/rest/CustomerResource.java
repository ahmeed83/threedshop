...
import app.focusit.threedshop.domain.Customer;
import app.focusit.threedshop.repository.CustomerRepository;
...
/**
 * REST controller for managing {@link app.focusit.threedshop.domain.Customer}.
 */
@RestController
@RequestMapping("/api")
@Transactional
