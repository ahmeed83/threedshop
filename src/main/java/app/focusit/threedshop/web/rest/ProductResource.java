...
import app.focusit.threedshop.domain.Product;
import app.focusit.threedshop.repository.ProductRepository;
...
/**
 * REST controller for managing {@link app.focusit.threedshop.domain.Product}.
 */
@RestController
@RequestMapping("/api")
@Transactional
