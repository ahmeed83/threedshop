...
describe('Category e2e test', () => {
  ...
  it('should load create Category page', async () => {
    ...
    expect(await categoryUpdatePage.getPageTitle().getAttribute('id')).to.match(/threedshopApp.category.home.createOrEditLabel/);
  ...
  it('should create and save Categories', async () => {
    async function createCategory() {
      ...
      await categoryUpdatePage.setLastUpdateInput('01-01-2001');
      expect(await categoryUpdatePage.getLastUpdateInput()).to.eq('2001-01-01');
  ...
  it('should delete last Category', async () => {
    ...
    expect(await categoryDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/threedshopApp.category.delete.question/);
