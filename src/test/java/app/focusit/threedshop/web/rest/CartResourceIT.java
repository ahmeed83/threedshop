...
public class CartResourceIT {
    ...
    private static final Double DEFAULT_CART_TOTAL = 1D;
    private static final Double UPDATED_CART_TOTAL = 2D;
    ...
    public void createCart() throws Exception {
        ...
        assertThat(testCart.getCartTotal()).isEqualTo(DEFAULT_CART_TOTAL);
    }
    ...
    @Test
    @Transactional
    public void checkCartTotalIsRequired() throws Exception {
    ...
    public void getAllCarts() throws Exception {
        ...
        restCartMockMvc.perform(get("/api/carts?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].cartTotal").value(hasItem(DEFAULT_CART_TOTAL.doubleValue())));
    }
    ...
    public void getCart() throws Exception {
        ...
        restCartMockMvc.perform(get("/api/carts/{id}", cart.getId()))
            ...
            .andExpect(jsonPath("$.cartTotal").value(DEFAULT_CART_TOTAL.doubleValue()));
    }
    ...
    public void updateCart() throws Exception {
        ...
        Cart testCart = cartList.get(cartList.size() - 1);
        assertThat(testCart.getCartTotal()).isEqualTo(UPDATED_CART_TOTAL);
    }
