...
import app.focusit.threedshop.config.audit.AuditEventConverter;
import app.focusit.threedshop.domain.PersistentAuditEvent;
...
import static app.focusit.threedshop.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
